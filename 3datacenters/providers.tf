...
resource rke_cluster "cluster" {
  nodes {
      address = "${scaleway_server.scw-host.0.public_ip}"
      user    = "rke"
#      internal_address = "${scaleway_server.scw-host.0.private_ip}"
      role    = ["etcd"]
  }
  nodes {
      address = "${digitalocean_droplet.dgo-host.0.ipv4_address}"
      user    = "rke"
#      internal_address = "${digitalocean_droplet.dgo-host.0.ipv4_address}"
      role    = ["etcd"]
  }
  nodes {
      address = "${vultr_instance.intance.0.ipv4_address}"
      user    = "rke"
#      internal_address = "${vultr_instance.intance.0.ipv4_address}"
      role    = ["etcd"]
  }
  nodes {
      address = "${scaleway_server.scw-host.1.public_ip}"
      user    = "rke"
#      internal_address = "${scaleway_server.scw-host.1.private_ip}"
      role    = ["worker","controlplane"]
  }
  nodes {
      address = "${digitalocean_droplet.dgo-host.1.ipv4_address}"
      user    = "rke"
#      internal_address = "${digitalocean_droplet.dgo-host.1.ipv4_address}"
      role    = ["worker","controlplane"]
  }
  nodes {
      address = "${vultr_instance.intance.1.ipv4_address}"
      user    = "rke"
#      internal_address = "${vultr_instance.intance.1.ipv4_address}"
      role    = ["worker","controlplane"]
  }
  nodes {
      address = "${scaleway_server.scw-host.2.public_ip}"
      user    = "rke"
#      internal_address = "${scaleway_server.scw-host.2.private_ip}"
      role    = ["worker"]
  }
  nodes {
      address = "${digitalocean_droplet.dgo-host.2.ipv4_address}"
      user    = "rke"
#      internal_address = "${digitalocean_droplet.dgo-host.2.ipv4_address}"
      role    = ["worker"]
  }
  nodes {
      address = "${vultr_instance.intance.2.ipv4_address}"
      user    = "rke"
#      internal_address = "${vultr_instance.intance.2.ipv4_address}"
      role    = ["worker"]
  }
}
